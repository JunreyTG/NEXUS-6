...
export function createApp(authService?: AuthService, adminService?: AdminManagementService, logService?: LogService, datasetService?: DatasetService, databaseRouter?: DatabaseRouter, datasetStorageService?: DatasetStorageService, datasetRecordService?: DatasetRecordService, reportService?: ReportService, publicService?: PublicService) {
  ...
  app.use("/api", createApiRouter(authService, adminService, logService, datasetService, databaseRouter, datasetStorageService, datasetRecordService, reportService, publicService));
